            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="form-web">
                        ...
                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-3 col-form-label">客服QQ</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" name="html_kefu" placeholder="输入QQ号"
                                >{{ config('sys.html_kefu') }}</textarea>
                                <div class="input_tips">
                                       注意：只需要将2933206697替换为你的qq号即可
                                </div>
                            </div>
                        </div>
                        
                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-3 col-form-label">防红开关</label>
                            <div class="col-sm-9">
                                <select name="qt[fhkg]" :value="'{{ config('sys.qt.fhkg','0') }}'"
                                        class="form-control">
                                    <option value="0">关闭</option>
                                    <option value="1">开启</option>
                                </select>
                                <div class="input_tips">
                                       自带接口的防红系统［api来源于龙珠防红］
                                </div>
                            </div>
                        </div>
