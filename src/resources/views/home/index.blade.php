        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="#modal-store" data-toggle="modal"
                   ...
                   class="float-right btn btn-sm btn-primary">添加域名</a>
            </div>
            <div class="card-header">
...
<!--友情链接-->
<br><div class="card">
<div class="card-header" style="background: #ffffff;color: white;">
    <div class="navbar-nav-scroll">
<ul class="navbar-nav bd-navbar-nav flex-row"><font color="black">▪</font>
            @foreach(\App\Helper::getIndexUrls() as $url)
                <li class="nav-item">
                    <a href="{{ $url[1] }}" target="_blank" class="nav-item">{{ $url[0] }}<font color="black">▪</font></a>
                </li>
            @endforeach
</ul>
    </div>
