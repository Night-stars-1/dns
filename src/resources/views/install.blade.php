...
<head>
    ...
    <title>小周二级域名程序安装 - {{ config('app.name') }}</title>
    ...
    <div class="col-12 col-md-4 offset-md-4 mt-3 mt-sm-5">
        ...
        @else
            <div class="card mb-3" v-if="step===1">
                <div class="card-header text-white bg-info ">运行环境检测－小周❃™美化</div>
                <div class="card-body">
                    @if($check=true)@endif
                ...
                <div class="card-body">
                    <form id="form-mysql">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" name="prefix" class="form-control" value="xzdns_">
                            </div>
                        </div>
                        <div class="form-group row">
            ...
            <div class="card mb-3" v-else-if="step===3">
                ...
                <div class="card-body">
                    ...
                    <li class="list-group-item">管理员账号 用户名：xiaozhou 密码:123456</li>
